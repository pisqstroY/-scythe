--[[
	femware UI Library
	Restyled from Cerberus

	Palette:
	  Main BG:       RGB(18, 16, 22)   — тёмный фиолетово-чёрный
	  Header:        RGB(30, 27, 36)   — тёмно-серый
	  Panel:         RGB(24, 21, 29)   — панели/страницы
	  Accent gray:   RGB(140, 140, 155)— приятный серый (основной акцент)
	  Secondary pink:RGB(225, 145, 165)— мягкий розовый (разделители, второстепенный)
	  Muted text:    RGB(142, 134, 155)— приглушённый текст
	  Placeholder:   RGB(118, 110, 132)— плейсхолдеры
]]

local ACCENT_GRAY = Color3.fromRGB(140, 140, 155)
local SECONDARY_PINK = Color3.fromRGB(225, 145, 165)
...
if not _G.JxereasExistingHooks.GuiDetectionBypass then
    ...
    old = hookfunc(ContentProvider.PreloadAsync, function(self, tbl, cb)
        ...
        task.spawn(function()
            ...
            if not s and e then err = e end
        end)
        if err then return old(self, tbl) end
        tbl = FilterTable(tbl)
        return old(self, tbl, cb)
    end)
    ...
    old = hookmetamethod(game, "__namecall", function(self, ...)
        ...
        if self == ContentProvider and (method == "PreloadAsync" or method == "preloadAsync") then
            ...
            if err then return old(self, args[1]) end
...
ClickSound.SoundId = "rbxassetid://123373842476302"
...
local function createOriginialElements()
	...
	local function createWindow()
		...
		background.BackgroundColor3 = Color3.fromRGB(18, 16, 22)
		...
		heading.BackgroundColor3 = Color3.fromRGB(30, 27, 36)
		...
		plus.ImageColor3 = Color3.fromRGB(155, 148, 168)
		plus.Visible = false
		...
		minus.ImageColor3 = Color3.fromRGB(220, 212, 232)
		...
		headingCornerHiding.BackgroundColor3 = Color3.fromRGB(30, 27, 36)
		...
		headingSeperator.BackgroundColor3 = SECONDARY_PINK
		...
		tabs.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		pageLogo.ImageColor3 = Color3.fromRGB(90, 82, 102)
	...
	local function createTab()
		...
		tab.Name = "Tab"
		tab.BackgroundColor3 = Color3.fromRGB(30, 27, 38)
		...
		tab.Text = ""
		tab.TextColor3 = Color3.fromRGB(142, 134, 155)
		tab.TextSize = 18
		...
		tabText.Text = "N/A"
		tabText.TextColor3 = Color3.fromRGB(142, 134, 155)
		tabText.TextSize = 18
		...
		tabSeperator.BackgroundColor3 = ACCENT_GRAY
	...
	local function createPage()
		...
		page.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		leftScrollingFrame.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		rightScrollingFrame.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
	...
	local function createSection()
		...
		section.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
	...
	local function createTitle()
		...
		titleText.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		designGradient.Color = ColorSequence.new{
			ColorSequenceKeypoint.new(0.00, Color3.fromRGB(24, 21, 29)),
			ColorSequenceKeypoint.new(0.50, SECONDARY_PINK),
			ColorSequenceKeypoint.new(1.00, Color3.fromRGB(24, 21, 29))
		}
	...
	local function createLabel()
		...
		label.Name = "Label"
		label.BackgroundColor3 = ACCENT_GRAY
		...
		labelBackground.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		labelText.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
	...
	local function createToggle()
		...
		boxBackground.BackgroundColor3 = ACCENT_GRAY
		...
		innerBox.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		centerBox.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		toggleImage.BackgroundColor3 = ACCENT_GRAY
		...
		toggleImage.ImageColor3 = Color3.fromRGB(24, 21, 29)
	...
	local function createButton()
		...
		circleBackground.BackgroundColor3 = ACCENT_GRAY
		...
		innerCircle.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		centerCircle.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		buttonCircle.BackgroundColor3 = ACCENT_GRAY
	...
	local function createDropdown()
		...
		dropdownButton.BackgroundColor3 = ACCENT_GRAY
		...
		buttonBackground.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		buttonInnerBackground.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		elementHolder.BackgroundColor3 = ACCENT_GRAY
		elementHolder.BorderSizePixel = 0
		...
		elementHolderBackground.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		elementHolderInnerBackground.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
	...
	local function createSlider()
		...
		numberText.PlaceholderColor3 = Color3.fromRGB(118, 110, 132)
		numberText.PlaceholderText = ""
		numberText.Text = "0"
		numberText.TextColor3 = Color3.fromRGB(142, 134, 155)
		...
		sliderBackground.BackgroundColor3 = ACCENT_GRAY
		...
		sliderInnerBackground.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		emptySliderBackground.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		slider.BackgroundColor3 = ACCENT_GRAY
	...
	local function createSearchBar()
		...
		searchBarFrame.BackgroundColor3 = ACCENT_GRAY
		...
		buttonBackgroundPadding.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		searchBox.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		searchBox.BackgroundTransparency = 1
		searchBox.BorderSizePixel = 0
		searchBox.Size = UDim2.new(1, 0, 1, 0)
		searchBox.Font = Enum.Font.Gotham
		searchBox.PlaceholderColor3 = Color3.fromRGB(118, 110, 132)
		searchBox.PlaceholderText = "N/A"
		searchBox.Text = ""
		searchBox.TextColor3 = Color3.fromRGB(142, 134, 155)
		...
		searchBoxBackground.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		searchImage.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
	...
	local function createKeybind()
		...
		keyText.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		keyText.BorderSizePixel = 0
		keyText.Size = UDim2.new(1, 0, 1, 0)
		keyText.Font = Enum.Font.Gotham
		keyText.Text = "N/A"
		keyText.TextColor3 = Color3.fromRGB(142, 134, 155)
		keyText.TextSize = 14
	...
	local function createTextBox()
		...
		textBoxText.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		textBoxText.PlaceholderColor3 = Color3.fromRGB(118, 110, 132)
		textBoxText.PlaceholderText = "Type here..."
		textBoxText.Text = ""
		textBoxText.TextXAlignment = Enum.TextXAlignment.Left
		textBoxText.TextColor3 = Color3.fromRGB(142, 134, 155)
	...
	local function createColorWheel()
		...
		boxBackground_2.BackgroundColor3 = ACCENT_GRAY
		...
		innerBox_2.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		colorValue.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		colorValue.PlaceholderColor3 = Color3.fromRGB(118, 110, 132)
		colorValue.Text = "255"
		colorValue.TextColor3 = Color3.fromRGB(142, 134, 155)
		...
		boxBackground_3.BackgroundColor3 = ACCENT_GRAY
		...
		innerBox_3.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		colorValue_2.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		colorValue_2.PlaceholderColor3 = Color3.fromRGB(118, 110, 132)
		colorValue_2.Text = "255"
		colorValue_2.TextColor3 = Color3.fromRGB(142, 134, 155)
		...
		boxBackground_4.BackgroundColor3 = ACCENT_GRAY
		...
		innerBox_4.BackgroundColor3 = Color3.fromRGB(10, 8, 14)
		...
		colorValue_3.BackgroundColor3 = Color3.fromRGB(24, 21, 29)
		...
		colorValue_3.PlaceholderColor3 = Color3.fromRGB(118, 110, 132)
		colorValue_3.Text = "255"
		colorValue_3.TextColor3 = Color3.fromRGB(142, 134, 155)
		...
		sliderBar.BackgroundColor3 = ACCENT_GRAY
...
function Library.new(windowName, constrainToScreen, width, height, visibilityKeybind, backgroundImageId)
	...
	heading.Title.Text = windowName or "femware"
...
function tabHandler:Section(sectionTitle)
...
function elementHandler:Button(buttonName, callback)
...
function elementHandler:TextBox(textBoxName, callback)
